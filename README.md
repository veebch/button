...
A method for running a script on your linux machine using a bluetooth (flic) button. The example is for a KEFLS50 wireless set of speakers, but can be adapted to any device that responds to commands made over your network.
