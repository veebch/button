...
A method for sending any command to a device on your local network using a bluetooth (flic) button. The example is for a KEFLS50 wireless set of speakers, but can be adapted to any device that responds to commands made over your network.
